...
const secondary = () => {
  return (
    <div className="mx-auto">
      <SEO 
        title="secondary Studies Kids Course Course" 
        description="Enroll in the secondary Studies Kids Course course at Nebras Academy. Learn online with certified Al-Azhar teachers." 
        canonical="/courses/Islamic"
      />
      <StructuredData data={{
  "@context": "https://schema.org",
  "@type": "Course",
  "name": "secondary Studies Kids Course",
  "description": "Learn secondary Studies Kids Course online with certified teachers from Al-Azhar.",
  "provider": {
    "@type": "Organization",
    "name": "Nebras Academy",
