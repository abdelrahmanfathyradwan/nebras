...
const About = () => {
  ...
  const aboutSchema = {
    ...
    "@type": "AboutPage",
    "name": "About Nebras Academy",
    "description": "Nebras Academy is your premier source of Quranic education with over a decade of excellence in online Quran education.",
    "url": "https://nebrasacademy.com/about"
  };
  ...
  return (
   <div className="max-w-6xl mx-auto px-4 py-12">
     <SEO 
       title="About Us" 
       description="Learn about Nebras Academy, our expert Quran teachers from Al-Azhar, and our mission to provide the best online Quran education." 
       canonical="/about"
     />
  ...
  <section className="mb-16">
    <div className="text-center mb-12">
      <h2 className="text-4xl font-bold text-secondary-700 mb-6">WHY CHOOSE NEBRAS ACADEMY?</h2>
      <div className="w-24 h-1 bg-amber-500 mx-auto"></div>
    </div>
  ...
  <section className="mb-16 bg-gradient-to-r from-secondary-50 to-amber-50 p-8 rounded-xl">
    <div className="text-center mb-8">
      <h2 className="text-4xl font-bold text-secondary-700 mb-6">ABOUT OUR QURAN TEACHERS</h2>
      <div className="w-24 h-1 bg-amber-500 mx-auto"></div>
    </div>
  ...
  <section className="bg-white rounded-xl shadow-lg p-8">
    <div className="text-center mb-8">
      <h2 className="text-4xl font-bold text-secondary-700 mb-6">HOW TO SIGN UP</h2>
      <div className="w-24 h-1 bg-amber-500 mx-auto"></div>
    </div>
